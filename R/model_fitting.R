...
fit_hal_timed <- function(label, X, Y, weights = NULL, family = "binomial",
                          ...
                          num_knots = SIM2_DEFAULT_NUM_KNOTS, foldid = NULL,
                          cv_folds = SIM2_DEFAULT_CV_FOLDS, cv_nlambda = 50,
...
make_hal_fit_psock_cluster <- function(worker_count) {
  ...
  package_mode <- identical(package_name, "aipwLocalDemo")
...
run_hal_jobs_local <- function(job_specs, fit_workers, backend = "auto",
