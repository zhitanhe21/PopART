...
#' with outer-cross-fitted highly adaptive lasso or XGBoost and returns
#' augmented inverse probability weighting estimates for arm-specific means, a
#' risk difference, and a risk ratio.
#'
#' @section Scope:
